...
MindfulnessBehavior::MindfulnessBehavior(Config *config, Floower *floower, BluetoothConnect *bluetoothConnect, WifiConnect *wifiConnect) 
        : SmartPowerBehavior(config, floower, bluetoothConnect, wifiConnect) {
}
